...
export default defineConfig({
  resolve: {
    ...
    // '@michaelthielemann/kestrel-publishing'` resolves through node_modules to `dist/` — a separate module instance from
    ...
    alias: {
      '@michaelthielemann/kestrel-publishing': fileURLToPath(new URL('./src/index.ts', import.meta.url)),
    },
  },
  test: {
