...
export default defineConfig({
  resolve: {
    ...
    // '@kestrel/publishing'` resolves through node_modules to `dist/` — a separate module instance from
    ...
    alias: {
      '@kestrel/publishing': fileURLToPath(new URL('./src/index.ts', import.meta.url)),
    },
  },
  test: {
