...
/** Whether a route's record was saved after its own last publish (beyond `toleranceMs`) — the
 *  save/publish stamp comparison every withholding decision in this module is built from.
 * @public
 */
...
/** The result of {@link heldRoutes}: which routes to withhold, and which of their prior published routes
