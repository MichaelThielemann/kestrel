/** The request headers `isCrossSiteWrite` reads to judge same-site vs. cross-site.
 * @public
 */
...
/** Whether a state-changing request looks cross-site, from `Sec-Fetch-Site`/`Origin`/`Referer` vs. `Host`.
 * @public
 */
