...
export default defineConfig({
  resolve: {
    ...
    // '@kestrel/collections'` resolves through node_modules to `dist/` — a separate module instance from
    ...
    alias: {
      '@kestrel/collections': fileURLToPath(new URL('./src/index.ts', import.meta.url)),
    },
  },
  test: {
