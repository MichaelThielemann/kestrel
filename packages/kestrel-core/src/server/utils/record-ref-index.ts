...
import { extractLocatedRecordRefs, extractRecordRefs, fieldIs } from '@michaelthielemann/kestrel-core'
import type { BuiltCollection, CollectionDef, FieldDef, FieldRef, LocatedRef } from '@michaelthielemann/kestrel-core'
