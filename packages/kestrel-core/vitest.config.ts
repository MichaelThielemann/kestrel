...
export default defineConfig({
  resolve: {
    // Without this, a bare `from '@michaelthielemann/kestrel-core'` (used both by this package's own test fixtures and by
    ...
    alias: {
      '@michaelthielemann/kestrel-core/client': fileURLToPath(new URL('./src/client.ts', import.meta.url)),
      '@michaelthielemann/kestrel-core': fileURLToPath(new URL('./src/index.ts', import.meta.url)),
    },
  },
  test: {
