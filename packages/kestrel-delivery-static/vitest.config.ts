...
export default defineConfig({
  resolve: {
    ...
    // '@kestrel/delivery-static'` resolves through node_modules to `dist/` — a separate module instance from
    ...
    alias: {
      '@kestrel/delivery-static': fileURLToPath(new URL('./src/index.ts', import.meta.url)),
    },
  },
  test: {
