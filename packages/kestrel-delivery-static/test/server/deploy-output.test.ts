...
import { deployStaticOutput, resolveOutputTarget, resolveOutputCreds, isEnvTrue, planS3Deploy, recordRouteDiscovery, readRouteDiscovery } from '../../src/server/deploy-output.js'
...
describe('planS3Deploy', () => {
  // Reconcile (--delete) is always-on, so a real S3 generate REQUIRES a dedicated prefix; `ok` has one.
