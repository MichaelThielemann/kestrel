...
import { planRelocateInto, planRename } from '../../../src/server/utils/relocate-plan.js'
import type { AffectedMedia, AffectedSet } from '../../../src/server/utils/media-ops.js'

const m = (over: Partial<AffectedMedia>): AffectedMedia => ({
  id: 1, storageKey: '', folder: null, filename: '', size: 0, derivatives: null, raw: {}, ...over,
})
