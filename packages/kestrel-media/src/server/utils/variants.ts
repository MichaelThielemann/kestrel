 ...
 */
export function readVariantRegistry(db: MediaDb): StoredVariant[] | null {
 ...
 */
export function activeVariants(db: MediaDb, fallback: ResolvedVariant[], presets: ResolvedVariant[] = []): ResolvedVariant[] {
