...
export default defineConfig({
  resolve: {
    ...
    // '@kestrel/delivery-live'` resolves through node_modules to `dist/` — a separate module instance from
    ...
    alias: {
      '@kestrel/delivery-live': fileURLToPath(new URL('./src/index.ts', import.meta.url)),
    },
  },
  test: {
