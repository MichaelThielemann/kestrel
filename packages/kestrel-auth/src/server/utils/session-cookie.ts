...
import { signSession, verifySession, sessionSettings, shouldRefreshSession } from './session.js'
...
/** Issues the signed session cookie for an authenticated request; returns the epoch-ms expiry set.
 * @public
 */
