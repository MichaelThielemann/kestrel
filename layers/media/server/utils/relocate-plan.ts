...
import { sanitizeFolder, buildKey, withExtension, extensionOf } from './naming'
import { childName, parentOf, rewritePrefix } from './folder-paths'
import type { OpItem, AffectedSet, AffectedMedia } from './media-ops'
