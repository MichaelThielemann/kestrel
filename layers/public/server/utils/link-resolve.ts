...
import { primaryLocale, prefixPrimaryLocale } from '../../../core/server/utils/locale'
 ...
 * populate plugin (read path, during `nuxt generate`) and the preview `/api/links/resolve` endpoint, so both
