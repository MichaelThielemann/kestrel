...
import { localePath } from '../../app/utils/locale-path'

/**
 * THE single definition of "stored page-like row → public output route": `localePath(path, the row's
 * OWN locale, …)`, or null when the row is missing or has no path. Every route-deriving site delegates
