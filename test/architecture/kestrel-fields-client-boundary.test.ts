...
const srcRoot = resolve(root, 'packages/kestrel-fields/src')
...
/** `@michaelthielemann/kestrel-fields/client` mirrors `@michaelthielemann/kestrel-core/client`'s browser-bundling boundary: a client file
 *  importing a runtime value from it must never transitively pull in a Node builtin — Vite externalizes an
 *  unresolvable `node:` specifier to an empty stub, and a NAMED import against that stub throws at module
 *  link time, before any application code runs. */
...
describe('@michaelthielemann/kestrel-fields/client — browser-safety boundary', () => {
